...
performance was evaluated and analyzed. The MPI version of the Himeno benchmark was 
ported to the coarray version and modified for fully using the non-blocking PUT. 
