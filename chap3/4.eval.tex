...
The programming code and communication pattern is illustrated in \fig{pingpong-code}.
%
...
on Fujitsu PRIMEHPC FX100 and HA-PACS/TCA, whose specs are described in \tab{specs}.
