...
%
  % Contribution
\bibitem{aa} Masahiro Nakao  et al.
...
%
\bibitem{Charles:2005:XOA:1103845.1094852} C. Philippe et al.
...
\bibitem{graphgolf} \url{http://research.nii.ac.jp/graphgolf}

\bibitem{NET:NET3230040405} Cerf, V. G. et al.
``A lower bound on the average shortest path length in regular graphs'',
Networks Vol.4, No.4 pp.335--342 (1974)

\bibitem{networkx} \url{https://networkx.github.io}

\bibitem{Metropolis1953} Metropolis Nicholas et al.
``Equation of State Calculations by Fast Computing Machines'',
The Journal of Chemical Physics, Vol.21, No.6, pp.1087--1092 (1953)

\bibitem{Kirkpatrick671} Kirkpatrick S. et	al.
