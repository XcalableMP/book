...
\def\enset{{\bf executing node set}}
\def\ensets{{\bf executing node sets}}

\def\narray{{\bf node array}}
\def\narrays{{\bf node arrays}}

\def\template{{\bf template}}
\def\templates{{\bf templates}}

\def\darray{{\bf distributed array}}
\def\darrays{{\bf distributed arrays}}

\def\garray{{\bf global array}}
\def\garrays{{\bf global arrays}}

\def\coarray{{\bf coarray}}
\def\coarrays{{\bf coarrays}}

%\def\global{{\bf global}}
\def\local{{\bf local}}
